...
const climaDl = async (query) => {
    const imagem = `https://wttr.in/${query}.png`
...
hasil.push({ lugar, continente, clima, temperatura, temperatura_minima, temperatura_max, visibilidade, umidade, vento, imagem })
return hasil
}

module.exports = { climaDl }